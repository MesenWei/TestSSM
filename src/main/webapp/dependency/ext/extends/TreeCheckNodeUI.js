...
Ext.extend(Ext.ux.TreeCheckNodeUI, Ext.tree.TreeNodeUI, {
    ...
    // private
    check : function(checked,no_cascade){
        var n = this.node;
		var tree = n.getOwnerTree();
		this.checkModel = tree.checkModel || this.checkModel;
		...
		if(this.checkModel == 'single'){
			...
			if((this.checkModel == 'cascade'&&!no_cascade) || this.checkModel == 'parentCascade'){
    ...
    toggleCheck : function(value,no_cascade){
    	var cb = this.checkbox;
        if(cb){
            var checked = (value === undefined ? !cb.checked : value);
            this.check(checked,no_cascade);
        }
    }
});