...
public class CopyFileUtil {
    ...
    public static boolean copyFile(String srcFileName, String destFileName,
        ...
        if (destFile.exists()) {
            ...
            if (overlay) {
                ...
                System.out.println("删除了文件："+destFileName);
            }
        } else {
            // 如果目标文件所在目录不存在，则创建目录
    ...
    public static void close(FileInputStream inStream){
        try {
            inStream.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void close(FileChannel in){
        try {
            in.close();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void close(FileOutputStream outStream){
        try {
            outStream.close();
        } catch (IOException e) {
            e.printStackTrace();
